<!-- DELETE USERS -->
<?php $page_title = "Member requests"; ?>
    ...
    <div class="card-body">
      ...
      <table class="table table-bordered table-hover">
        ...
        while ($row = mysqli_fetch_assoc($select_users)) {
            ...
            if (strlen($short_message) > 30) {
              // truncate string
              $stringCut = substr($short_message, 0, 30);
    ...
    <div class="card-footer">
      <nav aria-label="Contacts Page Navigation">
        ...
        if($count > 1){
            for($i = 1; $i <= $count; $i++){
                if($i == $page){
                    echo "<li class='page-item active'><a class='page-link' href='member-requests.php?page={$i}'>$i</a></li>";
                }else{
                    echo "<li class='page-item'><a class='page-link' href='member-requests.php?page={$i}'>$i</a></li>";
                }
            }
        }
        ?>
